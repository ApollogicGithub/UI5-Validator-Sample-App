		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#validatorsandbox-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"validatorsandbox-display": {
								"semanticObject": "validatorsandbox",
								"action": "display",
								"description": "Validator Sandbox ",
								"title": "Validator Sandbox",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=validatorsandbox",
									"url": sap.ui.require.toUrl("validatorsandbox")
								}
							}
						}
					}
